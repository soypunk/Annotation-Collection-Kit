...
// Local: localhost or local.example.com or example.loc
if(strpos($_SERVER['SERVER_NAME'], 'local.') !== FALSE || strpos($_SERVER['SERVER_NAME'], '.local') !== FALSE || strpos($_SERVER['SERVER_NAME'], '.loc') !== FALSE || $_SERVER['SERVER_NAME'] == 'localhost')
{
  define('ENV', 'local');
}
...
|--------------------------------------------------------------------------
|
| Which version of ACK is currently running?
|
*/

define('ACK_VERSION', '2.0.0');
...
|--------------------------------------------------------------------------
|
| When was the current version of ACK released?
| Format: YYYY/MM/DD
|
*/
